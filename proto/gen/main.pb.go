...
const file_main_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"main.proto\x12\x04main\x1a\x0estudents.proto\"\x1b\n" +
	"\tTeacherId\x12\x0e\n" +
	...
	"\n" +
	"TeacherIds\x12!\n" +
	"\x03ids\x18\x01 \x03(\v2\x0f.main.TeacherIdR\x03ids\"\x9b\x01\n" +
	"\aTeacher\x12\x0e\n" +
	...
	"\bTeachers\x12)\n" +
	"\bteachers\x18\x01 \x03(\v2\r.main.TeacherR\bteachers\"g\n" +
	"\x12GetTeachersRequest\x12'\n" +
	"\ateacher\x18\x01 \x01(\v2\r.main.TeacherR\ateacher\x12(\n" +
	"\asort_by\x18\x02 \x03(\v2\x0f.main.SortFieldR\x06sortBy2\xf5\x02\n" +
...
var file_main_proto_goTypes = []any{
	...
	(*Teacher)(nil),                    // 3: main.Teacher
	(*Teachers)(nil),                   // 4: main.Teachers
	(*GetTeachersRequest)(nil),         // 5: main.GetTeachersRequest
	(*SortField)(nil),                  // 6: main.SortField
	(*Students)(nil),                   // 7: main.Students
	(*StudentCount)(nil),               // 8: main.StudentCount
}
var file_main_proto_depIdxs = []int32{
	0,  // 0: main.TeacherIds.ids:type_name -> main.TeacherId
	3,  // 1: main.Teachers.teachers:type_name -> main.Teacher
	3,  // 2: main.GetTeachersRequest.teacher:type_name -> main.Teacher
	6,  // 3: main.GetTeachersRequest.sort_by:type_name -> main.SortField
	5,  // 4: main.TeachersService.GetTeachers:input_type -> main.GetTeachersRequest
	4,  // 5: main.TeachersService.AddTeachers:input_type -> main.Teachers
	4,  // 6: main.TeachersService.UpdateTeachers:input_type -> main.Teachers
	2,  // 7: main.TeachersService.DeleteTeachers:input_type -> main.TeacherIds
	0,  // 8: main.TeachersService.GetStudentsByClassTeacher:input_type -> main.TeacherId
	0,  // 9: main.TeachersService.GetStudentCountByClassTeacher:input_type -> main.TeacherId
	4,  // 10: main.TeachersService.GetTeachers:output_type -> main.Teachers
	4,  // 11: main.TeachersService.AddTeachers:output_type -> main.Teachers
	4,  // 12: main.TeachersService.UpdateTeachers:output_type -> main.Teachers
