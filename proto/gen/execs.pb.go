...
func (x *ExecCount) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecCount) ProtoMessage() {}

func (x *ExecCount) ProtoReflect() protoreflect.Message {
	mi := &file_execs_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecCount.ProtoReflect.Descriptor instead.
func (*ExecCount) Descriptor() ([]byte, []int) {
	return file_execs_proto_rawDescGZIP(), []int{8}
}

func (x *ExecCount) GetStatus() bool {
	if x != nil {
		return x.Status
	}
	return false
...
type GetExecsRequest struct {
	...
	PageNumber    int32                  `protobuf:"varint,3,opt,name=page_number,json=pageNumber,proto3" json:"page_number,omitempty"` //for pagination
	PageSize      int32                  `protobuf:"varint,4,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`       //for pagination
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_execs_proto_goTypes = []any{
	...
	(*ExecCount)(nil),               // 8: main.ExecCount
	(*ExecLoginResponse)(nil),       // 9: main.ExecLoginResponse
	(*ExecLoginRequest)(nil),        // 10: main.ExecLoginRequest
	(*DeleteExecsConfirmation)(nil), // 11: main.DeleteExecsConfirmation
	(*ExecId)(nil),                  // 12: main.ExecId
	(*ExecIds)(nil),                 // 13: main.ExecIds
	(*GetExecsRequest)(nil),         // 14: main.GetExecsRequest
